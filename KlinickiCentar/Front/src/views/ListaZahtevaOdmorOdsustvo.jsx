...
class ListaZahtevaOdmorOdsustvo extends Component {
  ...
  ucitajZahteveMedSestre() {
    const url1 =
      "http://localhost:8025/api/odmorodsustvo/listaZahtevaOdmorOdsustvoMS";
    console.log(url1);
  ...
  ucitajZahteveLekara() {
    const url1 =
      "http://localhost:8025/api/odmorodsustvo/listaZahtevaOdmorOdsustvoLekara";
    console.log(url1);
  ...
  handleOdobren = e => {
    ...
    if (e.currentTarget.id != "" && e.currentTarget.id != null) {
      const url1 =
        "http://localhost:8025/api/odmorodsustvo/zahtev/" + e.currentTarget.id;
      console.log(url1);
  ...
  handleOdbijenLekar = e => {
    ...
    if (e.currentTarget.id != "" && e.currentTarget.id != null) {
      //pronadji ceo zahtev na osnovu id-a
      const url1 =
        "http://localhost:8025/api/odmorodsustvo/zahtevL/" + e.currentTarget.id;
      console.log(url1);
  ...
  posalji() {
    ...
    const url3 =
      "http://localhost:8025/api/odmorodsustvo/odbijanjeMS/" +
  ...
  posaljiLekar() {
    ...
    console.log(this.state.razlogOdbijanja);
    const url3 =
      "http://localhost:8025/api/odmorodsustvo/odbijanjeL/" +
      this.state.razlogOdbijanja;
    axios
      .post(
        url3,
  ...
  render() {
    return (
      <div className="content">
        <Grid fluid>
          <Row>
            <Button className="DodajKlinikuDugme" onClick={this.prikazListeMS}>
              MEDICINSKE SESTRE
            </Button>
            <Button className="DodajKlinikuDugme" onClick={this.prikazListeL}>
              LEKARI
            </Button>
          </Row>
              ...
              <Card
                ...
                content={
                  <Table striped hover>
                    ...
                    <tbody>{this.listaZahtevaLekar()}</tbody>
                  </Table>
                }
              />
            ) : null}
